...
### 2.2 Activity Layer（System of Activity）
...
### 2.3 Management Layer（System of Management）
...
| `soa/_schema.yaml` | この業界のActivity Layer イベント種別とフィールド |
| `som/_schema.yaml` | この業界のManagement Layer 判定種別とフィールド |
...
| Activity Layer (System of Activity) | 現場活動の記録・帳簿。append-only |
| Management Layer (System of Management) | 判定・計画・ルール。版管理 |
